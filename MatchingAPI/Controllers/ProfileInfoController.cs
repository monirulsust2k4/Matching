...
namespace MatchingAPI.Controllers
{
    public class ProfileInfoController : ControllerBase
    {
        ...
        public async Task<CustomizeHelper> CreateUserProfileInfo([FromBody] UserProfileDTO head)
        {
            try
            {
        ...
        [SwaggerOperation(Description = "Example { BusinessUnitId: 0, ItemMasterId: 0, ItemCode: string, ItemName: string, ItemTypeId: 0,ItemTypeName:string,ItemCategoryId: 0,ItemCategoryName:string,ItemSubCategoryId:0,ItemSubCategoryName:string,Uomid:0,Uomname:string,GrossWeightKg:0,NetWeightKg:0,ActionBy:0, LastActionDateTime: 2020-02-09T11:42:09.172Z }")]
        public async Task<CustomizeHelper> EditUserProfileInfo([FromBody] UserProfileSummeryDTO editinfo)
        {
            try
            {
                string jwtToken = HttpContext.Request.Headers["Authorization"].ToString()?.Replace("Bearer ", "");
        ...
        [SwaggerOperation(Description = "Example { BusinessUnitId: 0, ItemMasterId: 0, ItemCode: string, ItemName: string, ItemTypeId: 0,ItemTypeName:string,ItemCategoryId: 0,ItemCategoryName:string,ItemSubCategoryId:0,ItemSubCategoryName:string,Uomid:0,Uomname:string,GrossWeightKg:0,NetWeightKg:0,ActionBy:0, LastActionDateTime: 2020-02-09T11:42:09.172Z }")]
        public async Task<CustomizeHelper> EditUserProfileEducationInfo([FromBody] List<CreateUserEducationRowDTO> editEducationinfo)
        {
            try
            {
                string jwtToken = HttpContext.Request.Headers["Authorization"].ToString()?.Replace("Bearer ", "");
        ...
        public async Task<CustomizeHelper> EditUserProfileWorkInfo([FromBody]  List<CreateUserWorkInfoRowDTO> editWorkinfo)
        {
            try
            {
        ...
        [SwaggerOperation(Description = "")]
        public async Task<CustomizeHelper> EditUserHobbiesNInterestInfo([FromBody]List<CreateUserRowDTO> editHobbiesinfo)
        {
            try
            {
